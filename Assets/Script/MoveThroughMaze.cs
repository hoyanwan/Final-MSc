...
public class MoveThroughMaze : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        transform.localPosition = new Vector3(Random.Range(-15f, +15f), 0, Random.Range(-15f, +15f));

        // Reset the goal's position to a random position
        targetTransform.localPosition = new Vector3(Random.Range(-15f, +15f), 0, Random.Range(-15f, +15f));
    }
